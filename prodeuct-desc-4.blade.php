<div itemscope itemtype="http://schema.org/Product" class="row" style="margin-left:10px;">
    <div class="col-lg-7 col-sm-12 col-xs-12" style="padding-bottom:60px" >
        <div  style="text-align:right" class="page-single-product-desc">
            <div  class="product-name " style="text-align:right;margin-bottom:20px;font-size: 39px!important;">
            ...
            <div itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating" class="pull-right" style="margin-top:-5px">
                ( 
                امتیاز:
