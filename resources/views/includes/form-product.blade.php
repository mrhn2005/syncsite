                    ...
                    <aside id="admin_sidebar" class="col-md-4">
                        <div class="form-group">
                          ...
                          <textarea name="desc_short" id="desc_short" cols="30" rows="5" class="form-control" >{{isset($product)?$product->desc_short:Request::old('desc_short')}}</textarea>
                        </div>
                         <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="quantity">
                            ...
                            <input type="number" name="quantity" id="quantity" class="form-control" value="{{isset($product)?$product->quantity:Request::old('quantity')}}">
                        </div>
                    ...
                    <div class="form-group">
                        <label for="name">
                            ...
                            <input type="text" name="name" class="form-control" id="name" value="{{isset($product)?$product->name:Request::old('name')}}">
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="desc" id="desc" cols="30" rows="10" class="form-control  my-editor" >{{isset($product)?$product->desc:Request::old('desc')}}</textarea>
                        </div>
                        ...
                        <div class="form-group row">
                              <div class="col-xs-6">
                                ...
                                <input type="text" name="weight_unit" id="weight_unit" class="form-control" size="60" value="{{isset($product)?$product->weight_unit:Request::old('weight_unit')}}" placeholder="گرم،کیلوگرم ، لیتر">
                              </div>
                              <div class="col-xs-6">
                                <label for="weight">
                                    وزن محصول
                                </label>
                                <input type="text" name="weight" id="weight" class="form-control" size="60" value="{{isset($product)?$product->weight:Request::old('weight')}}">
                              </div>
